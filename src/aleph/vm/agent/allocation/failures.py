...
# The boundary vocabulary, folded into the refusal one. Anything absent maps
# to "the hypervisor side refused", which is what the scheduler needs to know.
# The four that mean "this node is confused" (a VM the hypervisor cannot find
# or says already exists, a missing host, its catch-all) map to internal.
