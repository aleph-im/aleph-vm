...
def setup_webapp():
    ...
    cors_routes = [
        ...
        web.get("/control/machine/{ref}/confidential/measurement", operate_sev_measurement),
        web.post("/control/machine/{ref}/confidential/inject_secret", operate_sev_inject_secret),
