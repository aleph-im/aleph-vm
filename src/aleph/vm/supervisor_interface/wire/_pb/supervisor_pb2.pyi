...
class GpuDevice(google.protobuf.message.Message):
    ...
    arch: builtins.str
    """NVIDIA architecture family from the device id: "hopper" or "blackwell"; empty when unknown"""
    def __init__(
        self,
        *,
        pci_host: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["arch", b"arch", "cc_mode", b"cc_mode", "device_id", b"device_id", "model", b"model", "pci_host", b"pci_host", "supports_x_vga", b"supports_x_vga"]) -> None: ...
