...
//!
//! Test fixtures under `tests/fixtures/` were generated by the Python daemon's
//! actual models, captured from the Python daemon's own models before that daemon was removed (2026-08); they are frozen goldens now, edit them only to record a deliberate change (see src/test_fixtures.rs).
