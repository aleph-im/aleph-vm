...
//!
//! An SEV-SNP report and a TDX quote each carry 64 free bytes (`report_data`)
//! the platform signs verbatim. This module is the one canonical way to fill
//! them, so the attest agent and the aleph-rs verifier cannot drift: an ad-hoc
//! variant on either side reopens the attack described below.
//!
