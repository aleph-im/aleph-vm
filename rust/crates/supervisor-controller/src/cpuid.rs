...
impl SevHostInfo {
    ...
    /// and launch a bogus VM, whereas Rust fails closed: a confidential VM
    /// must never launch on a part that exposes the encrypted-memory leaf
    /// without supporting SEV.
