...
from aleph.vm.contract.errors import FileTooLargeError as SupFileTooLargeError
from aleph.vm.contract.errors import HostNotFoundError as SupHostNotFoundError
