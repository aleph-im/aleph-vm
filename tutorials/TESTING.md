...
```shell
python3 -m aleph.vm.agent --print-settings --very-verbose --system-logs --fake-data-program ./examples/example_fastapi
```
...
See [../vm_supervisor/README.md](../src/aleph/vm/agent/README.md) to install the system requirements.
