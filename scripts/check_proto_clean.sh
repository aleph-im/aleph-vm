...
# is hypervisor.proto + hypervisor_pb2.py (binary descriptors are
...
if ! git diff --quiet --exit-code -- \
    src/aleph/vm/hypervisor/_pb/hypervisor_pb2.py \
    src/aleph/vm/hypervisor/_pb/hypervisor_pb2_grpc.py \
    proto/; then
    echo
